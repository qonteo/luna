...
def extractDescriptors(body: Optional[ByteString] = None, filename: Optional[str] = None,
                       ...
                       warpedImage: bool = False, estimateAttributes: bool = False,
                       estimateEmotions: bool = False, estimateEthnicities: bool = False,
                       estimateHeadPose: bool = False,
                       estimateQuality: bool = False, scoreThreshold: float = 0,
                       extractDescriptor: bool = True, extractExif: bool = False,
                       pitchLt: Optional[float] = None, yawLt: Optional[float] = None, rollLt: Optional[float] = None,
                       lunaUrl: str = "http://127.0.0.1:5000/{}".format(DEFAULT_API),
                       raiseError: bool = False, **kwargs) -> LunaResponse:
    """
    ...
    queryParams = {"estimate_attributes": int(estimateAttributes),
                   ...
                   "estimate_head_pose": int(estimateHeadPose)}
    if pitchLt is not None:
        queryParams["pitch__lt"] = pitchLt
    if yawLt is not None:
        queryParams["yaw__lt"] = yawLt
    if rollLt is not None:
        queryParams["roll__lt"] = rollLt
...
def search(body: Optional[ByteString] = None, filename: Optional[str] = None, contentType: Optional[str] = None,
           ...
           warpedImage: bool = False, estimateAttributes: bool = False,
           estimateEthnicities: bool = False, estimateEmotions: bool = False, estimateHeadPose: bool = False,
           estimateQuality: bool = False, scoreThreshold: float = 0, extractExif: bool = False, listId: str = None,
           pitchLt: Optional[float] = None, yawLt: Optional[float] = None, rollLt: Optional[float] = None,
           descriptorIds: Optional[List[str]] = None,
           personIds: Optional[List[str]] = None, lunaUrl: str = "http://127.0.0.1:5000/{}".format(DEFAULT_API),
           raiseError: bool = False, **kwargs) -> LunaResponse:
    """

...
class LunaHttpClient:
    ...
    **ATTENTION**:  some LUNA API methods support authorization by login/password only.
    ...
    def __init__(self, api: Optional[int] = DEFAULT_API, endPoint: Optional[str] = "http://127.0.0.1",
    ...
    def extractDescriptors(self, body: Optional[ByteString] = None, filename: Optional[str] = None,
                           contentType: Optional[str] = None, warpedImage: bool = False,
                           estimateAttributes: bool = False, estimateEmotions: bool = False,
                           estimateEthnicities=False, estimateQuality: bool = False,
                           scoreThreshold: float = 0, extractDescriptor: bool = True,
                           estimateHeadPose: bool = False,
                           extractExif: bool = False, pitchLt: Optional[float] = None, yawLt: Optional[float] = None,
                           rollLt: Optional[float] = None, raiseError: bool = False, requestTimeOut: int = 60,
                           connectTimeOut: int = 20, requestId: Optional[str] = None) -> LunaResponse:
        """
        ...
        Args:
            ...
            yawLt: maximum deviation yaw angle from 0 (maximum 180)
            pitchLt: maximum deviation pitch angle from 0 (maximum 180)
            rollLt: maximum deviation roll angle from 0 (maximum 180)
        ...
        return extractDescriptors(body=body, filename=filename, contentType=contentType, warpedImage=warpedImage,
                                  ...
                                  rollLt=rollLt, pitchLt=pitchLt, yawLt=yawLt, estimateHeadPose=estimateHeadPose,
    ...
    def search(self, body: Optional[ByteString] = None, filename: Optional[str] = None,
               contentType: Optional[str] = None, limit: int = 3, warpedImage: bool = False,
               estimateAttributes: bool = False, estimateEthnicities: bool = False,
               estimateEmotions: bool = False, estimateQuality: bool = False,
               pitchLt: Optional[float] = None, yawLt: Optional[float] = None, rollLt: Optional[float] = None,
               scoreThreshold: float = 0, extractExif: bool = False, listId: [str] = None,
               estimateHeadPose: bool = False,
               descriptorIds: List[str] = None, personIds: List[str] = None, raiseError: bool = False,
               requestTimeOut: int = 60, connectTimeOut: int = 20,
               requestId: Optional[str] = None) -> LunaResponse:
        """
        ...
        return search(body=body, filename=filename, contentType=contentType, warpedImage=warpedImage,
                      ...
                      pitchLt=pitchLt, yawLt=yawLt, rollLt=rollLt, estimateHeadPose=estimateHeadPose,
                      raiseError=raiseError, requestTimeOut=requestTimeOut, connectTimeOut=connectTimeOut,
                      login=self.login, password=self.password, token=self.token, asyncRequest=self.asyncClient,
                      requestId=requestId)

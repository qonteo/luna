...
class CoreAPI(BaseAPI):
    ...
    def extractDescriptor(self, images: Union[Image, List[Image]], lunaRequestId: Optional[str] = None,
                          ...
                          scoreThreshold: Optional[float] = None, yawThreshold: Optional [float] = None,
                          pitchThreshold: Optional[float] = None, rollThreshold: Optional [float] = None,
                          extractDescriptor: Optional[bool] = None,
        ...
        Args:
            ...
            yawThreshold: For all face descriptors with yaw more than threshold won't be extracted descriptor.
            rollThreshold: For all face descriptors with roll more than threshold won't be extracted descriptor.
            yawThreshold: For all face descriptors with yaw more than threshold won't be extracted descriptor.
        ...
        if rollThreshold is not None:
            queries["roll_threshold"] = rollThreshold
        if yawThreshold is not None:
            queries["yaw_threshold"] = yawThreshold
        if pitchThreshold is not None:
            queries["pitch_threshold"] = pitchThreshold

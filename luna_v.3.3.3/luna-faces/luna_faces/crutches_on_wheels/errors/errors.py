...
class LunaApiError:
    ...
    BigExternalId = ErrorInfo(11026, 'Bad/incomplete input data', "Max length external id is 36 symbols")
    LowThreshold = ErrorInfo(11027, 'Face does not satisfy thresholds limits', "{}")
...
class RESTAPIError:
    ...
    BadInputFlat = ErrorInfo(12027, 'Bad/incomplete input data', "Failed to parse Flatbuf")
...
class LunaFaces:
    ...
    FaceWasNotAttachedToPerson = ErrorInfo(22010, 'Bad/incomplete input data', 'Face was not linked to the person')
